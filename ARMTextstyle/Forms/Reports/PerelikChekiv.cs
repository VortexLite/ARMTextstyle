...
{
    public partial class PerelikChekiv : Form
    {
        private ConnectionDB dbconnection;
        private SqlConnection connection;
        public PerelikChekiv()
        {
            InitializeComponent();
        ...
        private void PerelikChekiv_Load(object sender, EventArgs e)
        {

            string quary = $"SELECT * FROM Perelik_chekiv";
